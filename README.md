...
4.every # should be defined in the beginning of the code BEFORE ANYTHING ELSE (this include #include, #define, ....) ALSO dont put spaces between #include and <> + begin with a blank space + you will have to manually seperate the #define and the following variable (that is really simple to do and saves me a lot of time)
